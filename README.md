...
This can use DSK or NIB files. 

"LOAD *.NIBDSK" in the menu and wait for the TK2000 to boot. Sometimes its necessary to go back to the OSD menu, and select the "RESET" option after loading a .NIB file.
